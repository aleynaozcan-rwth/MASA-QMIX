...
with open(timeline_path, 'r') as f:
    for line in f:
        ...
        if line.startswith('=== EPISODE'):
            if current_episode is not None and dp_list:
                episodes.append({
        ...
        elif 'New job' in line and 'arrived' in line:
            dp_list.append('arrival')
        
        elif 'finished' in line and 'next queued' in line:
            dp_list.append('completion')
...
ax.set_xlabel('Cumulative Decision Points', fontsize=13, fontweight='bold')
