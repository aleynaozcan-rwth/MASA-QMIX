...
def get_mixer_args(args):
    ...
    # training schedule
    args.n_epoch     = 500    # DECREASED (15000 → 200) → quick run total training epochs #1 epoch = n_episodes tane episode.
    args.n_episodes  = 4      # DECREASED (5 → 3) → fewer episodes per epoch
    ...
    args.batch_size     = 24   # DECREASED (32 → 16)
    args.buffer_size    = 3000  # DECREASED (5000 → 1000)
